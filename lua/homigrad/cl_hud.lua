...
local randomGestures = {
	...
	{"Послать нахуй", function() RunConsoleCommand("hg_hand_gesture", "fuckyou") end},
	{"Одобрить", function() RunConsoleCommand("hg_hand_gesture" , "thumb_up") end},
}
